...
def main():
    ...
    if os.path.exists("dataset.pkl"):
        ...
        with open("dataset.pkl", "rb") as f:
            all_speaker_dataset = pkl.load(f)
    else:
        print("Generating dataset")
        all_speaker_dataset, _ = make_dataset("./dataset")
        print("\n\nSaving dataset.pkl")
        with open("dataset.pkl", "wb") as f:
            pkl.dump(all_speaker_dataset, f)
    
    for speaker_name, dataset in all_speaker_dataset.items():
        ...
        pd.DataFrame(results).transpose().to_csv(f"scores/{speaker_name}.csv")
        ...
        print(f"Done score for speker {speaker_name}")
