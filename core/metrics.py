...
#
# Source: https://github.com/ranchlai/speaker-verification/blob/bf76570476f37cce5446f4b10b15fad9ef6baafa/metrics.py#L21
...
def compute_eer(scores: Union[np.ndarray, List[float]],
    ...
    # print('same_id_scores - ', same_id_scores)
    diff_id_scores = scores[labels == 0]
    # print('diff_id_scores - ', diff_id_scores)
